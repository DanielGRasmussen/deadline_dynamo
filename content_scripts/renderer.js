		...
		for (let assignment of currentDay) {
			...
			elements = {
				...
				"estTime": {
					type: "p",
					class: "estTime",
					innerHTML: `${Math.round(assignment.estTime / 60 * 10) / 10}h / ${Math.round(assignment.totalWorkTime / 60 * 10) / 10}h`,
					parent: "right_side"
				},
				"due_date": {
					type: "p",
